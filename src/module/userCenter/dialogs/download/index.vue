<template>
	<van-popup class="dialog" v-model="show" @click-overlay="closeBox">
		...
		<div>
			...
			<p class="download-link"><a v-clipboard:copy="'http://www.trxwallet.net/TronWallet.apk'" v-clipboard:success="copyLink" v-clipboard:error="copyError">http://www.trxwallet.net/TronWallet.apk</a></p>
			...
			<p class="download-link"><a v-clipboard:copy="'itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/trxwallet/ios/master/manifest.plist'" v-clipboard:success="copyLink" v-clipboard:error="copyError">itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/trxwallet/ios/master/manifest.plist</a></p>
			<p class="download-tip">请在手机浏览器中打开链接</p>
		</div>
	</van-popup>
</template>
